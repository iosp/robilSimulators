...
{   
  ...
  public:
	...
	return;
 	...
 	//Removing reference to robil2****  _publisherGPSspeed = _nodeHandle.advertise<robil_msgs::GpsSpeed>(TOPIC_NAME_SPEED, 10);
...
//Removing reference to robil2****		robil_msgs::GpsSpeed msg_spd;
		...
		*****/
		...
		if(_gps_switch)
		{
		 ...
		 //Removing reference to robil2**** _publisherGPSspeed.publish(msg_spd);	
		}
    }
